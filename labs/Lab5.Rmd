...
```{r}
my_tracks1 <- get_my_saved_tracks(limit = 50, authorization = authorization_code, offset = 0)
my_tracks2 <- get_my_saved_tracks(limit = 50, authorization = authorization_code, offset = 50)
my_tracks3 <- get_my_saved_tracks(limit = 50, authorization = authorization_code, offset = 100)
my_tracks4 <- get_my_saved_tracks(limit = 50, authorization = authorization_code, offset = 150)
my_tracks5 <- get_my_saved_tracks(limit = 50, authorization = authorization_code, offset = 200)

my_tracks_200 <- bind_rows(my_tracks1, my_tracks2, my_tracks3, my_tracks4, my_tracks5)
```
...
```{r}
write.csv(my_tracks_200, "~/Documents/tracks.csv")
