...
* **This plot is not very useful because there is such a wide range of prices per day, and it might be more useful to look at patterns over coarser scales such as months. The points seem to be grouped vertically, which I would assume is because there are different varieties of pumpkins, and each variety has different average prices over time.**
...
* **The variety variable is most highly correlated with price. This is likely because different varieties of pumpkins have widely different prices, such as other fruit with different varieties.**
...
*Question 8:* What issues do you see with fitting a linear regression to this data? \* There is not a wide spread of data, and only 4 different package types. It is hard to fit a linear regression to data that does not have a lot of variety across the x axis.
