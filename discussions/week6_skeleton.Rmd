...
```{r, include=FALSE}
load(file = here::here("discussions", "data",  "rf_tune.rda"))
```
...
```{r, include=FALSE}
load(file = here::here("discussions", "data",  "xgb_tune.rda"))
```
...
```{r}
xgb_best = show_best(xgb_cv_tune, n = 1, metric = "roc_auc") #get metrics for best model
```
